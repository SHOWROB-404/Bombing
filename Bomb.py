...
# Author: SHOWROB KHAN.
# GitHub: https://github.com/SHOWROB-404
# Version: 4.1.0
#########################################
...
logo = f'''\033[1;37m  ____  _____  ____    ____  ______   _______     
 ...
 |_____|\____||_____||_____||_______/|____| |___| \n{50*"-"}
    print("\033[94m│ \033[95mAuthor : SHOWROB KHAN .                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/SHOWROB-404 \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : Showrob            \033[37mV4.1 \033[94m│".center(columns+15))
